...
import org.contentmine.norma.output.HtmlAggregate;
import org.contentmine.norma.output.HtmlDisplay;
...
//	public class NormaArgProcessor extends DefaultArgProcessor {
	...
	private static String ARGS_RESOURCE = NAConstants.NORMA_RESOURCE + "/"+NAConstants.ARGS_XML;
