 <xsl:stylesheet version="1.0"
    ...
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/front/front.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/body/body.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/back/back.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/figtab/figtab.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/general/general.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/math/math.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/refcite/refcite.xsl"/>
    <xsl:include href="src/main/resources/org/contentmine/norma/pubstyle/nlm/jats/fromjats.xsl"/>
