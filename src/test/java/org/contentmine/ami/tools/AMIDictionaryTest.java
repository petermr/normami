...
public class AMIDictionaryTest {
	...
	public void testCreateFungicideTerms() {
		String[] args = {
				...
				"--outformats", "html,xml",
				"--terms",  "Abamectin", "Actinomycin D", "Alexidine", "Amikacin", "Amphotericin B", "Ampicillin", "Anidulafungin", "Antimycin A", "Aureobasidin A", "Azithromycin", "Azoxystrobin", "Aztreonam", "Bacitracin", "Benomyl:", "Benznidazole", "Bifonazole", "Bleomycin", "Boscalid (2-chloro-N-(4`-chlorobiphenyl-2-yl) nicotinamide", "Brassinin", "Brefeldin A", "Calcofluor White", "Camptothecin", "Captan", "carbapenems", "Carbendazim", "Carbenicillin", "Carboxin", "Caspofungin", "Cefotaxime", "Ceftazidime", "Ceftriaxone", "Cefuroxime", "Cefuroximel", "Cephalexin", "Cercosporamide", "Chloramphenicol", "Chlorothalonil", "Ciprofloxacin", "Closantel", "Colistin", "Copper", "Copper sulphate", "Cycloheximide", "Cyclosporine A", "Cyproconazole", "Daptomycin", "Diethofencarb", "Difenoconazole", "Diniconazole", "Doxycycline", "Eflornithine", "Emamectin", "Epoxyconazole", "Ethambutol", "Farnesol", "Fenarimol", "Fenhexamid", "Fenpropidin", "Fluconazole", "Flucytosine", "Fludioxonil", "Flutriafol", "Gentamicin", "Gramicidin D", "Hydrogen peroxide", "Hygromycin B", "Hymexazol", "Imipenem", "Iprodione", "Isoniazid", "Itraconazole", "Ketoconazole", "Latrunculin A", "Leptomycin B", "Lincomycin", "Linezolid", "Mancozeb", "Mecillinam", "Meropenem", "Micafungin", "Miconazole", "Miltefosine", "Moxifloxacin", "Myriocin", "Naftifine", "Nalidixic acid", "Neomycin", "Nifurtimox", "Nikkomycin Z", "Nisin", "nitrofurantoin", "Norfloxacin", "Novobiocin", "Nystatin", "Oligomycin", "Oxacillin", "Oxolinic acid", "Oxytetracycline", "Paromomycin", "Penicillin", "Pentamidine", "Phenamacril", "phosphomycin", "Plumbagin", "Polymyxin B1", "posaconazole", "Prochloraz", "Propiconazole", "Pyrimethanil", "Rapamycin", "Resveratrol", "Rifampicin", "Rifampin", "Rose Bengal", "Rotenone", "Salicylhydroxamic acid (SHAM)", "Sordarin", "Spectinomycin", "Spiroxamine", "Streptomycin sulfate", "Strobilurin A", "Sulbactam", "Tebuconazole", "Teicoplanin", "Telithromycin", "terbinafine", "Tetracycline", "Thiabendazole", "Thiophanate-methyl", "Tiamulin", "Ticarcillin", "Tigecycline", "Tobramycin", "Triadimefon", "Trichostatin A", "Triclabendazole", "Triclosan", "Tricyclazole", "Tridemorph", "Trimethoprim", "Tunicamycin", "Tylosin", "Valinomycin", "Vancomycin", "Verapamil", "Vinclozolin", "Virginiamycin", "Voriconazole"
				};
		AMIDictionaryTool.main(args);
	}
		...
		public void testCreateWheatVarieties() {
			String[] args = {
					...
					"--outformats", "html,xml",
					"--terms", "Access", "Alchemy", "Ambrosia", "Amplify", "Arran", 
//					"Asagai", "Atlanta", "Bantam", "Battalion", "Belgrade", "Beluga", 
//					"Benedict", "Bennington", "Bentley", "Biscay", "Britannia", "Brompton",
//					"Brunel", "Buchan", "Butler", "Buzzer", "Carlton", "Cassius", "Chardonnay", 
//					"Charger", "Chatsworth", "Chilton", "Chronicle", "Claire", "Cocoon", "Conqueror",
//					"Consort", "Contender", "Cordiale", "Coronation", "Costello", "Cougar", "Crusoe", 
//					"Cubanita", "Dart", "Deben", "Defender", "Delphi", "Denman", "Dickens", "Dickson", 
//					"Director", "Dover", "Dunston", "Duxford", "Edmunds", "Einstein", "Elation", "Elicit", 
//					"Energise", "Equinox", "Evolution", "Exeter", "Fastnet", "Freiston", "Fugue", "Gallant", 
//					"Gatsby", "Gladiator", "Glasgow", "Gleam", "Goldengun", "Goodwill", "Grafton", "Graham", 
//					"Gravitas", "Gulliver", "Hardwicke", "Havana", "Hereford", "Hereward", "Heritage", "Horatio", 
//					"Humber", "Hurley", "Hyperion", "Icebreaker", "Icon", "Invicta", "Istabraq", "JB Diego", 
//					"Jorvik", "KWS Barrel", "KWS Basset", "KWS Bonham", "KWS Cashel", "KWS Cleveland", "KWS Crispin", 
//					"KWS Croft", "KWS Curlew", "KWS Dali", "KWS Evoke", "KWS Extase", "KWS Firefly", "KWS Gator", 
//					"KWS Gymnast", "KWS Horizon", "KWS Jackal", "KWS Kerrin", "KWS Kielder", "KWS Lili", "KWS Luther", 
//					"KWS Podium", "KWS Quartz", "KWS Rowan", "KWS Santiago", "KWS Saxtead", "KWS Silverstone", "KWS Siskin", 
//					"KWS Solo", "KWS Sterling", "KWS Target", "KWS Tempo", "KWS Trinity", "KWS Yaris", "KWS Zyatt", "Ketchum", 
//					"Kingdom", "Kipling", "LG Bletchley", "LG Cassidy", "LG Detroit", "LG Generation", "LG Interstellar", 
//					"LG Jigsaw", "LG Motown", "LG Rhythm", "LG Sabertooth", "LG Skyscraper", "LG Spotlight", "LG Sundance", 
//					"Lancaster", "Lear", "Leeds", "Limerick", "Macro", "Madrigal", "Malacca", "Marksman", "Marlowe", "Marston", 
//					"Mascot", "Monterey", "Monty", "Mosaic", "Moulton", "Musketeer", "Myriad", "Napier", "Nijinsky", "Oakley", 
//					"Option", "Orbit", "Panacea", "Panorama", "Pennant", "Phlebas", "Piranha", "QI", "Qplus", "Quest", 
//					"RGT Adventure", "RGT Conversion", "RGT Gravity", "RGT Illustrious", "RGT Knightsbridge", "RGT Marlborough", 
//					"RGT Paddington", "RGT Universe", "RGT Westminster", "Reflection", "Relay", "Revelation", "Riband", "Richmond", 
//					"Robigus", "Rocky", "Ruskin", "SW Tataros", "SY Epson", "SY Loki", "SY Medea", "Sahara", "Savannah", "Savello", 
//					"Scorpion 25", "Scout", "Senator", "Shabras", "Shamrock", "Sherlock", "Shire", "Shogun", "Skyfall", "Smuggler", 
//					"Soissons", "Solace", "Solstice", "Spyder", "Steadfast", "Stigg", "Stratosphere", "Tanker", "Tellus", "Timber", 
//					"Torch", "Torphins", "Trident", "Tuxedo", "Twister", "Vector", "Velocity", "Verso", "Viscount", "Walpole", 
//					"Warlock 24", "Warrior", "Weaver", "Welford", "Wizard", "Xi19", "Zebedee",
