...
public class BMCTest {
	...
	public void testBMCHTML() {
		...
		Assert.assertTrue("mosquito dir: "+NormaFixtures.MOSQUITOS_DIR, NormaFixtures.MOSQUITOS_DIR.exists());
...
//		Assert.assertNotNull("results.json", cTree.getExistingQuickscrapeMD());
		...
		String[] args = {
				...
				"--standalone", "true",
				"--transform",NAConstants.PUBSTYLE_RESOURCE+"/"+"bmc/xml2html.xsl", // stylesheet to convert 
		};
